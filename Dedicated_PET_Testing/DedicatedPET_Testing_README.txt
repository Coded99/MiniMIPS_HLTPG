...
Edited TestProgramGenerator.py, such that it only generates the the test program based on the dedicated Pseudo-exhaustive data in add.txt, logic.txt, mult.txt, shift.txt and sub.txt. 
